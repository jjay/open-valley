...
"""
Originally taken from https://gist.github.com/p2or/af5bc4fae39b16f8d505
Modified to align imported objects into grid and center pivot for a great
needs of Open Valley.
"""
...
class ImportMultipleObjs(bpy.types.Operator, ImportHelper):
    ...
    def execute(self, context):
        ...
        y = 0
        s = 4
        l = int(math.sqrt(len(bpy.data.objects)))
        ...
        for o in bpy.data.objects:
            o.select = True
            o.location = mathutils.Vector((-1.5, -1.5, 0))
            bpy.ops.object.transform_apply(location=True, rotation=True, scale=True)

            o.location = mathutils.Vector((x*s, y*s, 0))
            x += 1
            if x > l:
                y += 1
                x = 0
